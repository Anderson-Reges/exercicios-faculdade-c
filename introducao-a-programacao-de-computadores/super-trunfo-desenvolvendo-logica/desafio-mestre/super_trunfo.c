...
int main()
{
  ...
  float sum_card_1 = 0, sum_card_2 = 0;
  ...
  printf("\nEscolha qual atributo 1 deseja comparar:\n");
  printf("1. População\n");
  printf("2. Área\n");
  printf("3. PIB\n");
  ...
  printf("\nEscolha qual atributo 2 deseja comparar:\n");

  option_1 != 1 && printf("1. População\n");
  option_1 != 2 && printf("2. Área\n");
  option_1 != 3 && printf("3. PIB\n");
  option_1 != 4 && printf("4. Pontos Turísticos\n");
  option_1 != 5 && printf("5. Densidade demográfica\n");
  printf("Opção: ");
  scanf("%d", &option_2);
  ...
  {
  case 1:
    sum_card_1 += population_number_1;
    sum_card_2 += population_number_2;
    break;
  case 2:
    sum_card_1 += area_number_1;
    sum_card_2 += area_number_2;
    break;
  case 3:
    sum_card_1 += pib_number_1;
    sum_card_2 += pib_number_2;
    break;
  case 4:
    sum_card_1 += turistic_points_1;
    sum_card_2 += turistic_points_2;
    break;
  case 5:
    sum_card_1 += population_density_1;
    sum_card_2 += population_density_2;
    break;
  }
  ...
  /* Determinar o vencedor com base na soma */
  printf("\nSoma dos Atributos:\n");
  printf("Carta 1: %.2f\n", sum_card_1);
  printf("Carta 2: %.2f\n", sum_card_2);

  if (sum_card_1 > sum_card_2)
  {
    printf("Resultado Final: Carta 1 venceu a rodada!\n");
  }
  else if (sum_card_1 < sum_card_2)
  {
  ...
  /* Exibir os nomes dos países */
  printf("Carta 1 - %s (%s)\n", city_name_1, state_1);
  printf("Carta 2 - %s (%s)\n", city_name_2, state_2);

  /* Exibir os dois atributos usados na comparação */
